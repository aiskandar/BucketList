...
public class StateMachine {
    ...
    public static final String FB_OPENED_STATE_STR = "FB_OPENED";
    public static final String FB_CLOSED_STATE_STR = "FB_CLOSED";
    public static final String OFFLINE_STATE_STR = "OFFLINE";
    public static final String FB_GET_ME_STATE_STR = "FB_ME_GET";
    public static final String FBID_REGISTER_STATE_STR = "FBID_REGISTER";
    public static final String FB_GET_FRIENDS_STATE_STR = "FB_FRIENDS_GET";
    public static final String ONLINE_STATE_STR = "ONLINE";
    
    public static final String stateStr[] = {INIT_STATE_STR, SKIPPED_STATE_STR, FB_OPENED_STATE_STR, FB_CLOSED_STATE_STR, 
    	OFFLINE_STATE_STR, FB_GET_ME_STATE_STR, FBID_REGISTER_STATE_STR, FB_GET_FRIENDS_STATE_STR, ONLINE_STATE_STR};
    ...
    public static final String FBID_SERVER_REGISTER_ERROR_STR = "SERVER REGISTER ERROR";
    ...
    public static final String errorStr[] = {NO_ERROR_STR, FB_GET_ME_FAILED_ERROR_STR, FB_GET_FRIENDS_FAILED_ERROR_STR, 
    					FBID_SERVER_REGISTER_ERROR_STR, SERVER_SYNC_ERROR_STR, NETWORK_DISCONNECT_ERROR_STR}; 
